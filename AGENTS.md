...
keep prototype limits explicit. Generate `public/studio-plan.html` and `public/how-built.html` with
`pnpm studio:plan` (sources: `roadmap.json`, `how-built.json`); do not edit the
generated HTML directly. Run
