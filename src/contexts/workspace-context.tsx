...
// `studio`: the Content Studio pane for a folder — no file content of its
// own (the editor persists into the folder itself), so every file-only path
// (watcher, save, unload, dirty prompts) skips it like a diff tab. It is
// "file-like" only in shape (a path, a language, no browser surface).
type FileLikeTabKind = "file" | "diff" | "rich-diff" | "studio"
